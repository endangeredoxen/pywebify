...
class Template():
    ...
    def substitute(self, caps=None):
        ...
        self.template = self.template_raw.safe_substitute(self.subs)

    def write(self, dest=None, caps=True):
        self.template_raw = string.Template(open(self.templatePath).read())
